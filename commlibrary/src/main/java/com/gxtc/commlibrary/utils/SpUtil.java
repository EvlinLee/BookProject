...
public class SpUtil {
    ...
    public static void setUserWelfare(Context context, String welfare) {
        SpUtil.putString(context, "userWelfare", welfare);
    }

    public static String getUserWelfare(Context context) {
        return SpUtil.getString(context, "userWelfare");
    }

    public static void setUserSign(Context context, boolean sign) {
        SpUtil.putBoolean(context, "userSign", sign);
    }

    public static boolean getUserSign(Context context) {
        return SpUtil.getBoolean(context,"userSign");
    }
    ...
    public static void exitSystemt(Context context) {
        ...
        SpUtil.setUserSign(context, false);
        SpUtil.setUserWelfare(context, "");
