...
import com.zhangwan.app.ui.mine.SettingActivity;
...
public class JPushUtil {
    ...
    public static void init(Context context){
        ...
        boolean isOpen = SpUtil.getBoolean(context, ISOPEN, false);
        isOpenPush(context,isOpen);
    }

    public static void isOpenPush(Context context,boolean isOpen){
        if(isOpen){
            JPushInterface.resumePush(context);
            boolean sound = SpUtil.getBoolean(context, SOUNDSTATUS, true);
