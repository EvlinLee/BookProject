...
public class ExpandableTextView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        id_source_textview = (TextView) findViewById(R.id.tv_bookdetail_intro);
        ...
        id_expand_textview.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isCollapsed) {
                    id_expand_textview.setImageResource(R.drawable.intro_down);
                    if (listener != null) {
                        listener.onExpandStateChanged(true);
                    }
                    animation = new ExpandCollapseAnimation(getHeight(), collapsedHeight);
                } else {
                    id_expand_textview.setImageResource(R.drawable.intro_up);
                    if (listener != null) {
