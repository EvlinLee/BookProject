 ...
 */
public class ReadCircleImageView extends android.support.v7.widget.AppCompatImageView {
    //缩放类型
    ...
    //构造函数
    public ReadCircleImageView(Context context) {
        super(context);
        init();
    }
    //构造函数
    public ReadCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    /**
     * 构造函数
     */
    public ReadCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ReadCircleImageView, defStyle, 0);
        //通过TypedArray提供的一系列方法getXXXX取得我们在xml里定义的参数值；
        // 获取边界的宽度
        mBorderWidth = a.getDimensionPixelSize(R.styleable.ReadCircleImageView_border_width, DEFAULT_BORDER_WIDTH);
        // 获取边界的颜色
        mBorderColor = a.getColor(R.styleable.ReadCircleImageView_border_color, DEFAULT_BORDER_COLOR);
