...
import com.zhangwan.app.read.model.gen.DaoMaster;
...
public class DaoDbHelper {
    ...
    private DaoDbHelper(){
        //封装数据库的创建、更新、删除
        DaoMaster.DevOpenHelper openHelper = new MyOpenHelper(MyApplication.getInstance().getApplicationContext(),DB_NAME,null);
        //获取数据库
