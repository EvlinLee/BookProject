...
import com.zhangwan.app.read.widget.page.PageMode;
...
//                    mActivity.startActivityForResult(intent, com.example.newbiechen.ireader.ui.activity.NovelReadActivity.REQUEST_MORE_SETTING);
                    //关闭当前设置
                    dismiss();
                }
        );
